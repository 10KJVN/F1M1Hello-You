...
while Q1:
    print("Jij bent Pawrana, je woont met je familie in Afghanistan. (Let op gebruik HOOFDLETTERS!)")
    print("Je vader krijgt een dreigbrief van de Taliban.")
    print("'Er is geen tijd te verliezen, Parwana we moeten nu gaan.' Zegt hij vol doodsangst.")
    print("A: Blijven om te wachten op de rest van je familie ")
    print("B: Je pakt je favoriete knuffel en gaat mee. ")
    print("")
...
while Q3:
    print("Je vader heeft als doel om naar Europa te vluchten.")
    print("")
    print("Naar waar ben je van plan te vluchten?")
    print("A: Turkije ")
